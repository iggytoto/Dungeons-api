...
import static org.gassangaming.model.euqipment.human.HumanSpearmanEquipment.TABLE_NAME;

@Entity
@Table(name = TABLE_NAME)
@Getter
@Setter
public class HumanSpearmanEquipment  extends UnitEquip {
    ...
    public static final String TABLE_NAME = "human_spearman_equip";
